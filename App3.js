  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        />
        <TouchableOpacity onPress={() => {changeShape('Left'), Vibration.vibrate(1 * ONE_SECOND_IN_MS)}}>
          <Text style={{ marginTop: '80%', fontSize: 20 }}>Left</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => {changeShape('Right'), Vibration.vibrate(1 * ONE_SECOND_IN_MS)}}>
          <Text style={{ marginTop: '5%', fontSize: 20}}>Right</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => {changeShape('Brake'), Vibration.vibrate(5 * ONE_SECOND_IN_MS)}}>
